Pod::Spec.new do |s|
  s.name     = 'AFNetworkingMesh'
  s.version  = '2.5.4'
  s.license  = 'MIT'
  s.summary  = 'A delightful iOS and OS X networking framework.'
  s.homepage = 'https://github.com/3FramesLab/AFNetworkingMesh'
  s.social_media_url = 'https://twitter.com/AFNetworking'
  s.authors  = { 'Mattt Thompson' => 'm@mattt.me' }
  s.source   = { :git => 'https://github.com/3FramesLab/AFNetworkingMesh.git', :tag => s.version, :submodules => true }
  s.requires_arc = true
